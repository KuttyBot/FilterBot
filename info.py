...
GRP_LNK = environ.get('GRP_LNK', 'https://telegram.dog/CentralRequest')
CHNL_LNK = environ.get('CHNL_LNK', 'https://telegram.dog/Central_Links')
MSG_ALRT = environ.get('MSG_ALRT', 'What are you Looking At ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001749403188'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'CentralLinks_Contactbot')
